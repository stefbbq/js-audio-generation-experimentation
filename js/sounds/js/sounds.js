...
!function () {
    ...
    AudioSynth = function AudioSynth() { if (AudioSynthInstance instanceof AudioSynth) {
    ...
    setPub('generate', function (sound, note, octave, duration) {
        ...
        if (typeof (this._fileCache[sound][octave - 1][note][time]) != 'undefined') {
            ...
            var out = [
                'RIFF',
                pack(1, 4 + (8 + 24 /* chunk 1 length */) + (8 + 8 /* chunk 2 length */)),
                'WAVE',
                // chunk 1
                'fmt ',
                pack(1, 16),
...
Synth.loadSoundProfile({
    ...
    wave: function (i, sampleRate, frequency, volume) {
        ...
        return this.modulate[1](i, sampleRate, frequency, Math.pow(base(i, sampleRate, frequency, 0), 2) +
    ...
    wave: function (i, sampleRate, frequency) {
        var base = this.modulate[0];
        return this.modulate[1](i, sampleRate, frequency, base(i, sampleRate, frequency, 0) +
    ...
    wave: function (i, sampleRate, frequency) {
        ...
        return mod[0](i, sampleRate, frequency, mod[9](i, sampleRate, frequency, mod[2](i, sampleRate, frequency, Math.pow(base(i, sampleRate, frequency, 0), 3) +
...
function startPlaying() {
    ...
    piano.play(getNoteFromDecimal(Math.random()), 4, duration);
    setTimeout(function () {
